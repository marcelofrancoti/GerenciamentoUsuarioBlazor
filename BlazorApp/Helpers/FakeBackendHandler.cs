    ...
    public class FakeBackendHandler : HttpClientHandler
    {
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            async Task<HttpResponseMessage> authenticate()
            {
                ...
                var user = users.FirstOrDefault(x => x.Usuario == body.Username && x.Senha == body.Password);
            ...
            async Task<HttpResponseMessage> register()
            {
                ...
                if (users.Any(x => x.Usuario == body.Username))
                ...
                var user = new UserRecord {
                    ...
                    Senha = body.Password,
                    PrimeiroNome = body.FirstName,
                    UltimoNome = body.LastName
                };
            ...
            async Task<HttpResponseMessage> updateUser() 
            {
                ...
                if (user.Usuario != body.Username && users.Any(x => x.Usuario == body.Username))
                    return await error($"Username '{body.Username}' is already taken");
                ...
                user.PrimeiroNome = body.FirstName;
                user.UltimoNome = body.LastName;
                await _localStorageService.SetItem(usersKey, users);
